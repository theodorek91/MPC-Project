...
double ref_v = 100; // mph if ref ct and orientation errors are 0
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
	...
	//from Class notes, The cost is stored is the first element of `fg`.
    // Any additions to the cost should be added to `fg[0]`.
    fg[0] = 0;
	
	// The part of the cost based on the reference state.
	// 1000 multiplied to  influence the solver into keeping sequential 
	// values of CTE and Epsi closer together.
